...
_s(BlockNode, "oVy8dZhsZ0PA/POljDpegEMdhsc=", false, function() {
    return [
...
"[project]/src/core/domain/errors/DomainError.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/core/domain/errors/InvalidNestingError.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$core$2f$domain$2f$errors$2f$DomainError$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/core/domain/errors/DomainError.ts [app-client] (ecmascript)");
;
class InvalidNestingError extends __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$core$2f$domain$2f$errors$2f$DomainError$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DomainError"] {
...
"[project]/src/core/domain/entities/Node.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$core$2f$domain$2f$errors$2f$InvalidNestingError$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/core/domain/errors/InvalidNestingError.ts [app-client] (ecmascript)");
;
class Node {
    id;
    type;
    ...
    nestUnder(parentNode) {
        if (!parentNode.type.canContain(this.type)) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$core$2f$domain$2f$errors$2f$InvalidNestingError$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["InvalidNestingError"](parentNode.type.toString(), this.type.toString());
        }
        return new Node({
            ...this,
...
"[project]/src/core/domain/value-objects/NodeId.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/core/domain/value-objects/NodeType.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/core/domain/value-objects/Position.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/presentation/canvas/mappers/nodeMapper.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$core$2f$domain$2f$value$2d$objects$2f$NodeId$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/core/domain/value-objects/NodeId.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$core$2f$domain$2f$value$2d$objects$2f$NodeType$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/core/domain/value-objects/NodeType.ts [app-client] (ecmascript)");
;
;
...
const flowNodeToCore = (node)=>({
        id: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$core$2f$domain$2f$value$2d$objects$2f$NodeId$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NodeId"].from(node.id).toString(),
        type: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$core$2f$domain$2f$value$2d$objects$2f$NodeType$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NodeType"].from(node.data.nodeType).toString(),
        label: node.data.label,
        description: node.data.description,
        parentId: node.parentId ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$core$2f$domain$2f$value$2d$objects$2f$NodeId$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NodeId"].from(node.parentId).toString() : undefined,
        position: {
            x: node.position.x,
            y: node.position.y
        }
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$core$2f$domain$2f$entities$2f$Node$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/core/domain/entities/Node.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$core$2f$domain$2f$value$2d$objects$2f$NodeId$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/core/domain/value-objects/NodeId.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$core$2f$domain$2f$value$2d$objects$2f$NodeType$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/core/domain/value-objects/NodeType.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$core$2f$domain$2f$value$2d$objects$2f$Position$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/core/domain/value-objects/Position.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$presentation$2f$canvas$2f$mappers$2f$nodeMapper$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/presentation/canvas/mappers/nodeMapper.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$presentation$2f$stores$2f$canvasStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/presentation/stores/canvasStore.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$presentation$2f$stores$2f$scopeStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/presentation/stores/scopeStore.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
...
function NodePalette() {
    ...
    const handleCreateNode = (type)=>{
        ...
        const coreNode = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$core$2f$domain$2f$entities$2f$Node$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Node"]({
            id: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$core$2f$domain$2f$value$2d$objects$2f$NodeId$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NodeId"].create(),
            type: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$core$2f$domain$2f$value$2d$objects$2f$NodeType$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NodeType"].from(type),
            label: `${type} node`,
            description: '',
            position: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$core$2f$domain$2f$value$2d$objects$2f$Position$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Position"].from(Math.floor(Math.random() * 260), Math.floor(Math.random() * 260)),
            parentId: currentScopeId ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$core$2f$domain$2f$value$2d$objects$2f$NodeId$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NodeId"].from(currentScopeId) : undefined
        });
        addNode((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$presentation$2f$canvas$2f$mappers$2f$nodeMapper$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["coreNodeToFlow"])(coreNode, projectId));
    };
...
function FlowCanvasContent() {
    _s();
    const { nodes, edges, onNodesChange, onEdgesChange, onConnect, removeNode, removeEdge, pendingConnection, setPendingConnection, addTypedEdgeFromPending } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$presentation$2f$stores$2f$canvasStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCanvasStore"])();
    const currentScopeId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$presentation$2f$stores$2f$scopeStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useScopeStore"])({
...
_s(FlowCanvasContent, "I0tjG38hD4xnuwwOsArUeRxYYNM=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$presentation$2f$stores$2f$canvasStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCanvasStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$presentation$2f$stores$2f$scopeStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useScopeStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$presentation$2f$stores$2f$scopeStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useScopeStore"],
...
_s(CanvasInitializer, "ArcAkCm1MdJRf0wnZPIUo4pISSc=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$presentation$2f$stores$2f$canvasStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCanvasStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$presentation$2f$stores$2f$scopeStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useScopeStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$presentation$2f$stores$2f$scopeStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useScopeStore"]
...
_c = CanvasInitializer;
var _c;
__turbopack_context__.k.register(_c, "CanvasInitializer");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_524bcbc0._.js.map